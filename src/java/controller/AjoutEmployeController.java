 ...
 */
public class AjoutEmployeController extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String error = null;
            if (nom == null && prenom==null && dateNaissance==null ) {
                ...
                response.sendRedirect("AjoutEmployeController?erreur=" + error);
        }  else {
            try {
                new Employe(nom,prenom,dateNaissance ).ajoutEmpoye();
